...
func _physics_process(_delta: float) -> void:
	_handling_wheels_fix()


func _handling_wheels_fix():
...
func _on_amor_l_environment_touched(_body: Node2D) -> void:
	print("MAMORL")
	is_amor_l_touching = true


func _on_amor_r_environment_touched(_body: Node2D) -> void:
	is_amor_r_touching = true
	print("MAMORR")


func _on_amor_l_body_exited(_body: Node2D) -> void:
	is_amor_l_touching = false 


func _on_amor_r_body_exited(_body: Node2D) -> void:
